...
bool Compare(RouteModel::Node const* first_node, RouteModel::Node const* second_node)
{
...
{ // Create path_found vector
    ...
    auto cur_parant = current_node->parent;
    auto cur = current_node;
    path_found.insert(path_found.begin(), *current_node);
    while (cur_parant) {
        path_found.insert(path_found.begin(), *cur_parant);
        distance += cur_parant->distance(*cur);
        cur = cur_parant;
        cur_parant = cur_parant->parent;
    }
